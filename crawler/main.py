...
if __name__ == '__main__':
    ...
    #user = User("Owncloud668", 0, "http://localhost:8080/", login_data = {"user" : "admin", "password" : "admin"}, session="ABC")
    ...
    #user = User("MyBB1", 0, "http://localhost:8080/index.php", login_data= {"quick_username": "admin", "quick_password": "admin"}, session="ABC")
    #user = User("MyBB2", 0, "http://localhost:8080/admin/index.php", login_data= {"username": "admin", "password": "admin"}, session="ABC")
    user = User("LocalTest", 0)
    url = "http://localhost/test.php"
    #url = "http://localhost:8080/showthread.php?tid=1"
    #url = "http://localhost:8080/admin/"
    crawler_config = CrawlConfig("Was weiß ich", url, max_depth=3, max_click_depth=2, crawl_speed=CrawlSpeed.Fast)
